...
from attack.utils_tf import clip_eta


def projected_gradient_descent(model_fn, model_preprocess, x, eps, eps_iter, nb_iter, norm,
                               clip_min=None, clip_max=None, y=None, targeted=False, top_k=None,
  ...
  i = 0
  while i < nb_iter:
    adv_x = fast_gradient_method(model_fn, model_preprocess, adv_x, eps_iter, norm, clip_min=clip_min,
                                 clip_max=clip_max, y=y, targeted=targeted, top_k=top_k)
